                ...
                <div class="footer__bottom" id="bottom">
                    <div class="social">
                        ...
                        <a href="#" class="social__link facebook-icon">
                            <svg role="presentation" class="icon facebook--icon"><use xlink:href="#facebookicon" /></svg>
                        </a>
                        <a href="#" class="social__link twitter-icon">
                            <svg role="presentation" class="icon twitter--icon"><use xlink:href="#twittericon" /></svg>
                        </a>
                        <a href="#" class="social__link linkedin-icon">
                            <svg role="presentation" class="icon linkedin--icon"><use xlink:href="#linkedinicon" /></svg>
                        </a>
                    </div>
                    <div class="bottom">
