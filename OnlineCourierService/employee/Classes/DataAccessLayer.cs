...
namespace OnlineCourierService.employee.Classes
{
    ...
    public class DataAccessLayer
    {
        ...
        //public static List<Employee1> GetEmpinfoByEid(int Eid)
        //{
        //    List<Employee1> emps = new List<Employee1>();
        //    using (SqlConnection con = new SqlConnection(connectionstr))
        //    {
        ...
        //                emp.Bid = Convert.ToInt64(row.Field<decimal>("BID"));
        //                emp.Rid = Convert.ToInt32(row.Field<decimal>("RID"));
        //                emp.Bname = row.Field<string>("BNAME");
        //                emp.post = row.Field<string>("POST");
        //                emp.postindex = row.Field<int>("POSTINDEX");
        //                emp.status = row.Field<string>("STATUS");
        //                emps.Add(emp);
        //            }
        //        }
        //        catch (SqlException)
        ...
        //public static int UpdateEmpbyEID(int OLD_Eid,
        //    long OLD_Bid, int OLD_postindex, int OLD_status,
        //    long Bid, int postindex, int status)
        //{

        //    //int OLD_x = (OLD_status.Equals("Active") ? 1 : -1);
        //    //int x = (status.Equals("Active") ? 1 : -1);
        ...
        //        cmd.Parameters.AddWithValue("@EID", OLD_Eid);

        //        cmd.Parameters.AddWithValue("@OLDBID", OLD_Bid);
        //        cmd.Parameters.AddWithValue("@BID", Bid);

        //        cmd.Parameters.AddWithValue("@OLDPOST", OLD_postindex);
        //        cmd.Parameters.AddWithValue("@POST", postindex);

        //        cmd.Parameters.AddWithValue("@OLDSTATUS", OLD_status);
        //        cmd.Parameters.AddWithValue("@STATUS", OLD_status);
