<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EresetPassword.aspx.cs" Inherits="OnlineCourierService.employee.EresetPassword" %>
...
<body style="background-image:url('./img/Prim.jpg')">
    <form id="form1" runat="server">
        <div class="page">
            ...
            <nav class="navigation">
                <asp:HyperLink ID="logo" CssClass="logo proj-logo" runat="server" NavigateUrl="~/employee/login.aspx"></asp:HyperLink>
                <h1 class="intro">
                    <asp:Label ID="Luser" runat="server" Text="Employee Reset Password"></asp:Label>
                </h1>
            </nav>
            <div class="container">
                <div class="content">
                    ...
                    <div class="inputbox">
                        <asp:TextBox ID="TBnewPass" CssClass="input" runat="server" autofocus="true"></asp:TextBox>
                    ...
                    <div class="inputbox">
                        <asp:TextBox ID="TBCnewPass" CssClass="input" runat="server" autofocus="true"></asp:TextBox>
